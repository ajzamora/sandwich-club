...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(LOG_TAG, sandwich.toString());
        if (sandwich == null) {
...
//            mAlsoKnownAsTv.setText(String.valueOf(sandwich.getAlsoKnownAs()));
//        }
//        if (!sandwich.getIngredients().isEmpty()) {
//            mIngredientsTv.setText(String.valueOf(sandwich.getIngredients()));
//        }
    }
